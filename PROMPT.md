...
Improve the contract in a way where it can automatically find TRX/USD price. Currently it's done by hand. Since the entirety of the contract works fine, do not change anything and only modify this part. But give me the whole contract again with asked improvements.